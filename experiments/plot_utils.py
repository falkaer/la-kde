...
def plot_contour(mesh, levels=8, cmap='viridis', solid=True, norm=None, ax=None, **kwargs):
    import matplotlib.pyplot as plt
...
def plot_kde_colormesh(kde, X, cmap='viridis', show_points=False, low=None, high=None, sizes=None, norm=None, ax=None):
    import matplotlib.pyplot as plt
